...
class DynamicRouterControlComponentTest {
    ...
    @Mock
    protected DynamicRouterControlConfiguration configuration;
    ...
    protected void setup() {
        ...
        endpointFactory = new DynamicRouterControlEndpointFactory() {
            ...
            public DynamicRouterControlEndpoint getInstance(
                    String uri, DynamicRouterControlComponent component, String controlAction,
                    DynamicRouterControlConfiguration configuration) {
                return endpoint;
            }
        };
        component = new DynamicRouterControlComponent(context);
        component.setControlEndpointFactorySupplier(() -> endpointFactory);
