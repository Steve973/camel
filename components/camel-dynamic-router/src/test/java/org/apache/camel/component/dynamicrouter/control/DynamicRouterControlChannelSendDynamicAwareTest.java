...
import static org.apache.camel.component.dynamicrouter.control.DynamicRouterControlChannelSendDynamicAware.URI_PARAMS_TO_HEADER_NAMES;
...
class DynamicRouterControlChannelSendDynamicAwareTest {
    ...
    void createPreProcessor() throws Exception {
        ...
        Mockito.doNothing().when(message).setHeader(CONTROL_ACTION, "subscribe");
